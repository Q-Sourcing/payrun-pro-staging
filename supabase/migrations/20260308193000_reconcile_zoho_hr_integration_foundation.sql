-- Zoho HR integration reconciliation:
-- Applies the missing Zoho HR schema on environments where
-- 20260308173000 was recorded in migration history but the objects are absent.
