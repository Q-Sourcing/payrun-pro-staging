...
-- Create the super admin user role (you'll need to sign up first, then run this manually with the actual user_id)
-- This is a placeholder comment - you'll add the role after the user signs up