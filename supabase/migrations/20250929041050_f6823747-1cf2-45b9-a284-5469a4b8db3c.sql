...
CREATE POLICY "Authenticated users can view all benefits" ON public.benefits FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage benefits" ON public.benefits FOR ALL TO authenticated USING (true);

CREATE POLICY "Authenticated users can view all pay groups" ON public.pay_groups FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage pay groups" ON public.pay_groups FOR ALL TO authenticated USING (true);
...
CREATE POLICY "Authenticated users can view all pay runs" ON public.pay_runs FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage pay runs" ON public.pay_runs FOR ALL TO authenticated USING (true);

CREATE POLICY "Authenticated users can view all pay items" ON public.pay_items FOR SELECT TO authenticated USING (true);
CREATE POLICY "Authenticated users can manage pay items" ON public.pay_items FOR ALL TO authenticated USING (true);
