...
async function fixDavidGroup() {
    console.log('🔧 Fixing "david group" in pay_group_master...');
    ...
    console.log('✅ Successfully updated "david group" record:');
    console.log(data);
    ...
    console.log('   This fix ensures "david group" will appear in the Create Pay Run dialog.');
}
