...
export const createEmployeeSchema = z.object({
  ...
  personal_email: z.string().email('Invalid personal email address').max(255, 'Personal email is too long').optional(),
  work_phone: z.string().max(20, 'Work phone number is too long').optional(),
  ...
  engagement_type: z.enum(['Permanent', 'Contract', 'Temporary', 'Casual', 'Trainee', 'Intern']).optional(),
  ...
  citizenship: z.string().max(100, 'Citizenship is too long').optional(),
  ...
  designation: z.string().max(150, 'Designation is too long').optional(),
  work_location: z.string().max(150, 'Work location is too long').optional(),
  // Bank details
