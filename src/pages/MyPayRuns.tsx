...
export default function MyPayRuns() {
  return (
    <div className="space-y-6">
      <PageHeader
        title="My Pay Runs"
        subtitle="View and manage pay runs assigned to your department"
        actions={
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-800 mb-2">My Department Pay Runs</h3>
        <p className="text-slate-500 mb-6 max-w-sm mx-auto">
          This section will show only the pay runs you have permission to view and manage. 
          Perfect for payroll managers and department heads.
        </p>
