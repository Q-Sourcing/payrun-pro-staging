...
CREATE OR REPLACE VIEW "public"."paygroup_employees_view" AS
 SELECT "pge"."id" AS "assignment_id",
    "pge"."pay_group_id",
    ...
    "pg"."pay_frequency",
    "e"."id" AS "employee_id",
    ((COALESCE("e"."first_name", ''::"text") || ' '::"text") || COALESCE("e"."last_name", ''::"text")) AS "employee_name",
    "e"."email" AS "employee_email",
    "e"."employee_type",
    "e"."pay_rate",
    "e"."pay_type",
    "e"."country" AS "employee_country",
    "e"."currency" AS "employee_currency",
    "e"."status" AS "employee_status",
    "pge"."assigned_at" AS "assigned_on",
    "pge"."removed_at",
    "pge"."active"
   FROM (("public"."paygroup_employees" "pge"
     LEFT JOIN "public"."pay_groups" "pg" ON (("pg"."id" = "pge"."pay_group_id")))
     LEFT JOIN "public"."employees" "e" ON (("e"."id" = "pge"."employee_id")))
  WHERE (("pge"."active" = true) AND ("e"."status" = 'active'::"text"))
  ORDER BY "pg"."name", ((COALESCE("e"."first_name", ''::"text") || ' '::"text") || COALESCE("e"."last_name", ''::"text"));
